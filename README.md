...
✨ *"A backend developer who solves problems by connecting data and systems"*
...
- 🏢 **Samil PwC AC** (2025.08 ~ / Software Engineer)

**🏆 Awards**

- 2024 KDT Hackathon / President’s Award from the Korea Skills Quality Authority
...
- **Vertex AI latency optimization**  
  Reduced cross-cloud LLM call latency by introducing HTTP connection pooling with `requests.Session` and `aiohttp.ClientSession` keepalive.
...
<!--
<a href="https://github.com/devxb/gitanimals">
  <img src="https://render.gitanimals.org/farms/singingsandhill" width="1000" height="120"/>
</a>
-->
